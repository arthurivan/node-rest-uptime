 ...
 */
 ...
 workers.alertUserToStatusChange = function(newCheckData){
   //var msg = 'hi- can you see my message - arthur';
...
workers.rotateLogs = () => {
   // Get all the logs that are not compressed
           ...
           if (!err) {
            ...
            _logs.truncate(logId, (err) => {
              if (!err) {
                ...
                debug("Error truncating one of the log files", err);
              }
            })
           } else {
  ...
  // use zlib to createGzip
  
  // collect the logs
  // create read stream and write stream
  // pip read to write .txt.gz
 ...
 // Timer to execute the logs compression process once a day
